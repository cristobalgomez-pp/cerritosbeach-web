...
export const EMERGENCY_CONTACTS: EmergencyContact[] = [
  ...
  {
    id: "2",
    type: { es: "Rescate acuático", en: "Water rescue" },
    name: "Salvavidas Cerritos",
    phone: "+52 612 145 0000",
    hours: "8:00 — 18:00",
    notes: {
      es: "Hay torre de salvavidas frente al acceso principal de la playa.",
      en: "There's a lifeguard tower in front of the main beach access.",
    },
  },
  {
    id: "3",
    type: { es: "Cruz Roja", en: "Red Cross" },
    name: "Cruz Roja Pescadero",
    phone: "+52 612 145 0911",
    hours: "24/7",
  },
  {
    id: "4",
    type: { es: "Policía local", en: "Local police" },
    name: "Policía Pescadero",
    phone: "+52 612 145 0100",
    hours: "24/7",
  },
];
